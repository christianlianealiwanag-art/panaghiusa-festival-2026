        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="mt-8 text-xl text-gray-700 leading-9">
              Welcome to the Panaghiusa Festival 2026 Children&apos;s Safari
              Festival! Join us for a fun-filled Safari Adventure with exciting
              camps, amazing performances, games, prizes, and unforgettable
